 ...
 * Write a method to insert M in to N such that M starts at bit j and ends at
 ...
 * not fully fit between bit 3 and bit 2. EXAMPLE: Input: N = 1000000000 (512),
 * M = 10011, i = 2, j = 6 Output: N = 10001001100
 * 
 * @author Marcel
 *
 */
