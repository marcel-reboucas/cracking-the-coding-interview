 ...
 * @author Marcel
 * 
 * Edit: My solution only works with Binary Search Trees, since this is how I implemented the find.
 * However, it could be changed to find all subtrees starting with a certain value, and then
 * seeing if each subtree matches what we are looking for.
 *
 */
public class Question8 {
	...
	public static boolean equals(TreeNode t1, TreeNode t2){
		...
		if (t1 == null && t2 == null) { return true; } // both are null, ok
		if (t1 == null || t2 == null) { return false; } // one of them is null, not ok
