 ...
 * aabcccccaaa would become a2blc5a3. If the "compressed" 
 * string would not become smaller than the original string, 
 * your method should return the original string.
 *
 * Possible improvements after seeing the solution:
 * - a method to count the size of the output string could be created 
 *   to return early, without having to create the compressed string.
 */
