 ...
 * other.
 * 
 * Possible improvements after seeing the solution: - returning early if the
 * string lengths are different - instead of comparing the char maps, just sort
 * each string and compare the strings
 */
