...
public class Question7 {
	...
	public static void main(String[] args) {
		...
		Color[][] picture = new Color[][] { { Color.Red, Color.Red, Color.Yellow, Color.Red },
				{ Color.Green, Color.Red, Color.Yellow, Color.Red }, { Color.Yellow, Color.Red, Color.Red, Color.Blue },
